...
proc create_hier_cell_OV7670_GRAYSCALE_TO_AXIS { parentCell nameHier } {
  ...
  # Create instance: ddr_to_axis_reader_S, and set properties
  set ddr_to_axis_reader_S [ create_bd_cell -type ip -vlnv xilinx.com:hls:ddr_to_axis_reader_SD:1.0 ddr_to_axis_reader_S ]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins ddr_to_axis_reader_S/s_axi_AXILiteS]
  ...
  connect_bd_intf_net -intf_net ddr_to_axis_reader_SD_0_m_axi_base_ddr_addr [get_bd_intf_pins axi_interconnect_1/S00_AXI] [get_bd_intf_pins ddr_to_axis_reader_S/m_axi_base_ddr_addr]
  connect_bd_intf_net -intf_net ddr_to_axis_reader_SD_0_outStream_channel_1_V [get_bd_intf_pins ddr_to_axis_reader_S/outStream_channel_1_V] [get_bd_intf_pins mux_sd_ov_1/data_in_sd_V_V]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT1_JITTER {202.205} \
   CONFIG.CLKOUT1_PHASE_ERROR {276.131} \
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {25.175} \
   CONFIG.CLKOUT2_DRIVES {BUFG} \
   CONFIG.CLKOUT2_JITTER {204.875} \
   CONFIG.CLKOUT2_PHASE_ERROR {276.131} \
   ...
   CONFIG.MMCM_CLKFBOUT_MULT_F {99.125} \
   CONFIG.MMCM_CLKIN1_PERIOD {10.000} \
   CONFIG.MMCM_CLKIN2_PERIOD {10.000} \
   CONFIG.MMCM_CLKOUT0_DIVIDE_F {56.250} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU_MIO_25_PULLUPDOWN {disable} \
   ...
   CONFIG.PSU__IRQ_P2F_TTC0__INT1 {1} \
   CONFIG.PSU__IRQ_P2F_TTC0__INT2 {1} \
  ...
  connect_bd_intf_net -intf_net VDMA_AXIM_READER [get_bd_intf_pins VDMA/AXIM_READER] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP1_FPD]
  connect_bd_intf_net -intf_net VDMA_AXIM_WRITER [get_bd_intf_pins VDMA/AXIM_WRITER] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP0_FPD]
  ...
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_FPD [get_bd_intf_pins processing_system7_0_axi_periph/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM1_FPD [get_bd_intf_pins OV7670_GRAYSCALE_TO_AXIS/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM1_FPD]
  ...
  connect_bd_net -net ap_start_1 [get_bd_pins OV7670_GRAYSCALE_TO_AXIS/ap_start] [get_bd_pins VDMA/ap_start] [get_bd_pins const_true/dout]
...
HDL_ATTRIBUTE.DEBUG_IN_BD {true} \
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins VDMA/clk_out] [get_bd_pins clk_gen_25M_24M/clk_out1] [get_bd_pins reset_25M/slowest_sync_clk]
...
HDL_ATTRIBUTE.DEBUG_IN_BD {true} \
  ...
  connect_bd_net -net reset_25M_peripheral_aresetn [get_bd_pins VDMA/aresetn_out] [get_bd_pins reset_25M/peripheral_aresetn]
...
HDL_ATTRIBUTE.DEBUG_IN_BD {true} \
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0xA0041000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_gpio_pl_reset/S_AXI/Reg] SEG_axi_gpio_pl_reset_Reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0xB0000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs OV7670_GRAYSCALE_TO_AXIS/ddr_to_axis_reader_S/s_axi_AXILiteS/Reg] SEG_ddr_to_axis_reader_SD_0_Reg
  ...
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces OV7670_GRAYSCALE_TO_AXIS/ddr_to_axis_reader_S/Data_m_axi_base_ddr_addr] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP2_DDR_LOW
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces VDMA/axis_to_ddr_writer_0/Data_m_axi_base_ddr_addr] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP0_DDR_LOW
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces VDMA/axis_to_ddr_writer_CHROMA/Data_m_axi_base_ddr_addr] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP0_DDR_LOW
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces VDMA/axis_to_ddr_writer_LUMA/Data_m_axi_base_ddr_addr] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP0_DDR_LOW
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces VDMA/ddr_to_axis_reader_0/Data_m_axi_base_ddr_addr] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP1_DDR_LOW

  # Exclude Address Segments
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces OV7670_GRAYSCALE_TO_AXIS/ddr_to_axis_reader_S/Data_m_axi_base_ddr_addr] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP2_LPS_OCM
  exclude_bd_addr_seg [get_bd_addr_segs OV7670_GRAYSCALE_TO_AXIS/ddr_to_axis_reader_S/Data_m_axi_base_ddr_addr/SEG_zynq_ultra_ps_e_0_HP2_LPS_OCM]

  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces VDMA/axis_to_ddr_writer_0/Data_m_axi_base_ddr_addr] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP0_LPS_OCM
  exclude_bd_addr_seg [get_bd_addr_segs VDMA/axis_to_ddr_writer_0/Data_m_axi_base_ddr_addr/SEG_zynq_ultra_ps_e_0_HP0_LPS_OCM]

  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces VDMA/axis_to_ddr_writer_CHROMA/Data_m_axi_base_ddr_addr] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP0_LPS_OCM
  exclude_bd_addr_seg [get_bd_addr_segs VDMA/axis_to_ddr_writer_CHROMA/Data_m_axi_base_ddr_addr/SEG_zynq_ultra_ps_e_0_HP0_LPS_OCM]

  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces VDMA/axis_to_ddr_writer_LUMA/Data_m_axi_base_ddr_addr] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP0_LPS_OCM
  exclude_bd_addr_seg [get_bd_addr_segs VDMA/axis_to_ddr_writer_LUMA/Data_m_axi_base_ddr_addr/SEG_zynq_ultra_ps_e_0_HP0_LPS_OCM]

  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces VDMA/ddr_to_axis_reader_0/Data_m_axi_base_ddr_addr] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP1_LPS_OCM
  exclude_bd_addr_seg [get_bd_addr_segs VDMA/ddr_to_axis_reader_0/Data_m_axi_base_ddr_addr/SEG_zynq_ultra_ps_e_0_HP1_LPS_OCM]
