...
set psu_mio_init_data {
    ...
    mask_write 0XFF180204 0xFFFFFFFF 0x57000006
    ...
    mask_write 0XFF180148 0x03FFFFFF 0x00000000
    ...
    mask_write 0XFF18014C 0x03FFFFFF 0x00000039
    ...
    mask_write 0XFF180160 0x03FFF3FF 0x03FFF3FF
    ...
    mask_write 0XFF180164 0x03FFFFFF 0x033FFFFF
    ...
    mask_write 0XFF180180 0x03FFFFFF 0x03FFF000
    ...
    mask_write 0XFF18017C 0x03FFF000 0x03FFF000
		# : LOOPBACK
...
set psu_peripherals_pre_init_data {
    ...
    mask_write 0XFF5E0108 0x013F3F07 0x00012302
}
...
set psu_peripherals_init_data {
    ...
    mask_write 0XFF180320 0x33803380 0x00800080
		# : SD0 BASE CLOCK
