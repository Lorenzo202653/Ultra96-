...
//PORTS
      ...
      bit  maxigp2_awready;
      bit  [127 : 0] maxigp2_wdata;
      bit  [15 : 0] maxigp2_wstrb;
      bit  maxigp2_wlast;
      bit  maxigp2_wvalid;
      bit  maxigp2_wready;
...
//REG DECLARATIONS
      ...
      reg pl_clk0;
      reg ps_pl_irq_gpio;
      reg ps_pl_irq_ttc0_0;
      reg ps_pl_irq_ttc0_1;
      reg ps_pl_irq_ttc0_2;
      string ip_name;
      reg disable_port;
...
import "DPI-C" function void ps8_init_c_model();
 ...
 always@(posedge pl_ps_irq0[1])
 begin
  ps8_set_input_pl_ps_irq0(1,1);
end
...
import "DPI-C" function void ps8_set_inputs_s_axi_hp1_fpd_saxihp1_fpd_aclk(
...
import "DPI-C" function void ps8_get_outputs_s_axi_hp1_fpd_saxihp1_fpd_aclk(
output bit saxigp3_awready,
output bit saxigp3_wready,
...
always@(posedge saxihp1_fpd_aclk)
  begin

   ps8_set_ip_context(ip_name);

   ps8_set_inputs_s_axi_hp1_fpd_saxihp1_fpd_aclk(
    saxigp3_awid,
    saxigp3_awaddr,
    saxigp3_awlen,
    saxigp3_awsize,
   ...
   ps8_simulate_single_cycle_saxihp1_fpd_aclk();

   ps8_get_outputs_s_axi_hp1_fpd_saxihp1_fpd_aclk(
    saxigp3_awready,
    saxigp3_wready,
    saxigp3_bid,
    saxigp3_bresp,
