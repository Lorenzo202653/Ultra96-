...
{
   static XScuGic intc;
   static XGpio axi_gpio_frame_intr_Gpio;
...

   {
      ...
      print("\r\nRunning GpioInputExample() for axi_gpio_frame_intr...\r\n");

      u32 DataRead;
      
      status = GpioInputExample(XPAR_AXI_GPIO_FRAME_INTR_DEVICE_ID, &DataRead);
   ...
   }
   {
      ...
      Status = GpioIntrExample(&intc, &axi_gpio_frame_intr_Gpio, \
                               XPAR_AXI_GPIO_FRAME_INTR_DEVICE_ID, \
                               XPAR_FABRIC_AXI_GPIO_FRAME_INTR_IP2INTC_IRPT_INTR, \
...

   {
      ...
      print("\r\nRunning GpioOutputExample() for axi_gpio_pl_reset...\r\n");

      status = GpioOutputExample(XPAR_AXI_GPIO_PL_RESET_DEVICE_ID,1);
...

   {
      ...
      Status = SpiPsSelfTestExample(XPAR_PSU_SPI_0_DEVICE_ID);
...

   {
      ...
      Status = SpiPsSelfTestExample(XPAR_PSU_SPI_1_DEVICE_ID);
   ...
   /*
    * Peripheral Test will not be run for psu_uart_1
