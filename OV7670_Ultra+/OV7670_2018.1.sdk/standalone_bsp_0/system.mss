...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = axis_to_ddr_writer
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = VDMA_axis_to_ddr_writer_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axis_to_ddr_writer
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = VDMA_axis_to_ddr_writer_CHROMA
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axis_to_ddr_writer
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = VDMA_axis_to_ddr_writer_LUMA
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = ddr_to_axis_reader
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = VDMA_ddr_to_axis_reader_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.3
 PARAMETER HW_INSTANCE = axi_gpio_frame_intr
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.3
 PARAMETER HW_INSTANCE = axi_gpio_pl_reset
END
